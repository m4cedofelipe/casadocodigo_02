		...
		<ul class="clearfix book-collection">
			...
			<c:forEach items="${produtos }" var="produto">
				<li>
					...
					<img width="143" height="202" src="https://cdn.shopify.com/s/files/1/0155/7645/products/java8-featured_large.png?v=1411490181" alt="Java 8 Prático" title="${produto.titulo}" /> 
